    ...
    <>
      ...
      <div className="text-white mt-44 border border-[#00ff01] w-[700px] ml-[620px]">
        ...
        <div className="text-center">
          <h2 className="text-center font-bold text-lg text-[#00ff01]">
            DETAIL
          </h2>
      ...
      <div className="flex justify-center mt-4">
        <Link to="/account">
          <button className="h-[60px] w-[160px] py-4 mx-6">Back Account</button>
        </Link>
        <Link to="/">
          <button className="h-[60px] w-[160px] py-4 mx-6">Back Home</button>
        </Link>
        <Link to="/contactUs">
          <button className="h-[60px] w-[160px] py-4 mx-6">
            Some Problem?
          </button>
        </Link>
      </div>
